...
class EfficientADCuvisDataset(Dataset):
    ...
    def __init__(
        ...
        :param imagenet_dir: Path to the imageNet files needed for training. default: '../data/ImageNet_6_channel'
        ...
        if self.mode == "train":
            ...
            if "_ok_ok_" in file_path:
                ...
                if os.path.exists(self.gt[file_path]):
                    ...
                    )(mask).squeeze(0)  # Resize it in the same way
                else:
